		...
		<div class="panel-footer">
			...
			<nav class="panel-menu">
				<ul>
					...
					<li><a class="link-translatable" data-link-traslation="privacy" href="<?php if(isset($localizedLinks) && isset($localizedLinks['privacy']) && isset($localizedLinks['privacy']['it'])): echo $localizedLinks['privacy']['it']; else: echo '#'; endif; ?>">Cookies & Privacy Policy</a></li>
					<li><a class="link-translatable" data-link-traslation="credits" href="<?php echo $link_it; ?>">Credits</a></li>
				</ul>
			</nav>
		</div>
	</div>
